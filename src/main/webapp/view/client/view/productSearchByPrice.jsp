    ...
    <div class="row">
      ...
      <div class="col-sm-9 padding-right">
        ...
        <div class="features_items"><!--features_items-->
          ...
          <c:forEach items="${productSearchByPrice}" var="p">
          ...
          <ul class="pagination">
            <c:if test="${currentPage != 1}">
              <li class="page-item"><a class="page-link"
                                       href="?brand=${br}&priceFrom=${pf}&priceTo=${pt}&page=${currentPage-1}">&laquo;</a>
              </li>
            </c:if>
            ...
            <c:forEach begin="1" end="${numOfPages}" var="i">
              <c:choose>
                ...
                <c:otherwise>
                  <li class="page-item"><a class="page-link"
                                           href="?brand=${br}&priceFrom=${pf}&priceTo=${pt}&page=${i}">${i}</a>
                  </li>
                </c:otherwise>
              </c:choose>
            </c:forEach>
            ...
            <c:if test="${currentPage lt numOfPages}">
              <li class="page-item"><a class="page-link"
                                       href="?brand=${br}&priceFrom=${pf}&priceTo=${pt}&page=${currentPage+1}">&raquo;</a>
              </li>
            </c:if>
          </ul>
        </div><!--features_items-->
