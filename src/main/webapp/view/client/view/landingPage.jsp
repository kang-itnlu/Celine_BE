          ...
          <div class="row no-gutters align-items-center ">
            ...
            <div class="col-lg-8 col-md-7">
              <div class="slider-product-content">
                <h1 class="slider-title mb-10" data-animation="fadeInUp" data-delay="0.3s">Sale sập sàn 50%</h1>
                <p class="mb-25" data-animation="fadeInUp" data-delay="0.9s">Khuyến mãi giáng sinh - Sale off lên đến 50%. Khi mua hàng bạn còn có cơ hội nhận những phần quà hấp dẫn. Hãy đến với chúng tôi ngay thôi</p>
                <a class="main-btn" href="shop.html" data-animation="fadeInUp" data-delay="1.5s">Shop now <i class="lni-chevron-right"></i></a>
      ...
      <div class="single-slider">
        <div class="slider-bg">
          <div class="row no-gutters align-items-center">
            ...
            <div class="col-lg-8 col-md-7">
              <div class="slider-product-content">
                <h1 class="slider-title mb-10" data-animation="fadeInUp" data-delay="0.3s">Ưu đãi hấp dẫn</h1>
                <p class="mb-25" data-animation="fadeInUp" data-delay="0.9s">Mua từ 3 sản phẩm trở lên bạn sẽ nhận được ưu đãi giảm 10% tổng hóa đơn. Còn chần chờ gì nữa, hãy đến mua sắm cùng chúng tôi</p>
                <a class="main-btn" href="shop.html" data-animation="fadeInUp" data-delay="1.5s">Shop now <i class="lni-chevron-right"></i></a>
              </div> <!-- slider product content -->
            </div>
          </div> <!-- row -->
      ...
      <div class="single-slider">
        <div class="slider-bg">
          <div class="row no-gutters align-items-center">
            ...
            <div class="col-lg-8 col-md-7">
              <div class="slider-product-content">
                <h1 class="slider-title mb-10" data-animation="fadeInUp" data-delay="0.3s">Cùng khám phá nào!!!</h1>
                <a class="main-btn" href="index.html" data-animation="fadeInUp" data-delay="1.5s">Let's go<i class="lni-chevron-right"></i></a>
              </div> <!-- slider product content -->
            </div>
          </div> <!-- row -->
        </div> <!-- container -->
