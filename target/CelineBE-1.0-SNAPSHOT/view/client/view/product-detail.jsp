...
<nav role= "navigation"  class="bread">
    <ul class="breadcrumb" style="background-color:#eef9f9">
        <li class="breadcrumb-item"><a href="#">Céline</a></li>
        ...
        <div class="product__infor">
            ...
            <div class="product__detail">
                ...
                <div class="product__number">
                    ...
                    var qty = result.value; if( !isNaN(qty) & qty > 1 ) result.value--;return false;" type='button' value='-' style="padding: 0 5px; border-radius: 4px; border: 1px solid gray;" />
                        <input id='quantity' min='1' name='quantity' type='text' value='1' style="text-align:center;"/>
                        <input onclick="var result = document.getElementById('quantity'); var qty = result.value; if( !isNaN(qty)) result.value++;return false;" type='button' value='+' style="padding: 0 5px; border-radius: 4px;border: 1px solid gray;"/>
                    </div>
                </div>
                ...
                <div id="product__describe">
                    <div id="product__describe-icon" style="color:teal; cursor: pointer;"><i class="fas fa-angle-right"></i>MÔ TẢ</div>
                ...
                <div id="product__detail-more" >
                    <div id="product__describe-icon1" style="color:teal;cursor: pointer;"><i class="fas fa-angle-right"></i>CHI TIẾT SẢN PHẨM</div>
                ...
                <div id="product__comment">
                    <div id="product__comment-icon2" style="color:teal;cursor: pointer;padding-bottom: 12px;"><i class="fas fa-angle-right"></i>ĐÁNH GIÁ(1)</div>
                    <div id="product__comment-text" style="display: none;">
                        <div class="product__comment-text1">
                            <div class="product__comment-text1-cmt">
                                <img src="${url}/images/home/man_comment.jpg" alt="" style="width: 20px;height: 20px;">
                                <p>Jacky Nguyen</p>
                            </div>
                        ...
                        <div class="product__comment-input">
                            <input type="text" class="product__comment-input-first" placeholder="Bình luận.........">
                        ...
                        <div class="productinfo text-center">
                            <div id="product-img">
                                <a  href="${pageContext.request.contextPath }/product/detail?id=${p.id}">
                                    <img src="${imgUrl2}" alt=""  id="img__sp"/></a></div>
