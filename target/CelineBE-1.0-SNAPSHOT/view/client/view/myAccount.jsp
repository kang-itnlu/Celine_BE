          ...
          <div id="information">
            ...
            <form class="form-horizontal">
              <fieldset class="fieldset">
                ...
                <div class="form-group">
                  <label class="col-md-2 col-sm-3 col-xs-12 control-label">Tên của bạn</label>
                  <div class="col-md-10 col-sm-9 col-xs-12">
                    <input type="text" class="form-control" value="${sessionScope.account.username}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-2 col-sm-3 col-xs-12 control-label">Họ của bạn</label>
                  <div class="col-md-10 col-sm-9 col-xs-12">
                    <input type="text" class="form-control" value="${sessionScope.account.username}">
                  </div>
                </div>
              ...
              <fieldset class="fieldset">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10 col-sm-9 col-xs-12">
                    <input type="password" class="form-control" value="${sessionScope.account.password}">
